const { ModalContent, ModalHeader, ModalCloseButton, ModalBody, FormControl, FormLabel, Input, ModalFooter, Button, Modal, useDisclosure, ModalOverlay } = require("@chakra-ui/react")
          ...
          <ModalContent as="form" onSubmit={handleSubmit(createRoutine)}>
            ...
            <ModalBody pb={6}>
              <FormControl>
                ...
                <Input ref={initialRef} placeholder="First name" name="name"
        ref={register({
          required: "Required"
        })}
/>
              ...
              <FormControl mt={4}>
                ...
                <Input placeholder="Last name" name="user" ref={register({
          required: "Required"
        })}/>
              </FormControl>
            </ModalBody>
